...
source_folder = "/media/user01/HDD_4TB/AK_GOOGLE_APKS/vt_filtered_window/2010"
#source_folder = "/media/user01/HDD_4TB/AK_GOOGLE_APKS/grplay_filtered_taost_ctgry/87"
#source_folder = "/media/user01/HDD_4TB/AK_GOOGLE_APKS/grplay_filtered_taost_ctgry/55"
#output_path = "/media/user01/HDD_4TB/AK_GOOGLE_APKS/output_vt_taost_manifest/55" + "/"
output_path = "/media/user01/HDD_4TB/AK_GOOGLE_APKS/output_vt_wndow_manifest/2010" + "/"
...
def parse_android_manifest(manifest_path):
    ...
    components['servicesSize'] = len(services)
    ...
    components['activitiesSize'] = len(activities)
...
def save_file(apk_name, parsed_activities, output_path):
    apk_details = {"apkName": apk_name, "componentDetails": parsed_activities}
